...
from .views import TemplateTrainViewSet, DocumentCreateViewSet, TemplateMetadataViewSet, DocumentUpdateViewSet
...
router.register(r'update-document', DocumentUpdateViewSet, basename='update-document')
